...
public class MatrixLiteralNode extends ExpressionNode
{
    public final List<ArrayLiteralNode> components;

    @SuppressWarnings("unchecked")
    public MatrixLiteralNode (Span span, Object components) {
        super(span);
